"""Render rapido do vestido decimado pra confirmar visual antes do Mixamo."""
import bpy, math, mathutils
bpy.ops.wm.read_factory_settings(use_empty=True)
bpy.ops.import_scene.fbx(filepath=r"E:\References\3D\alice_vestido_mixamo.fbx", automatic_bone_orientation=True)
...
sc.render.filepath=r"D:\vestido_dec.png"
